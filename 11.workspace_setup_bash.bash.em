...
source $WORKSPACE_SCRIPTS/completion/thor_onboard.sh
source $WORKSPACE_SCRIPTS/completion/thor_field.sh
source $WORKSPACE_SCRIPTS/completion/thor_uninstall.sh
